                    ...
                    <div class="card-body">
                        ...
                        <div x-data="{ expanded: false }">
                            <p class="card-text mb-1" x-show="!expanded">
                                {{ Str::limit($review->comment, 500) }}
                            </p>
                            <p class="card-text mb-1" x-show="expanded" style="display: none;">
                                {{ $review->comment }}
                            </p>
                            @if(Str::length($review->comment) > 500)
        ...
        @auth
            <form wire:submit="save">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea wire:model="comment" id="comment" class="form-control @error('comment') is-invalid @enderror"
                        rows="3" placeholder="{{ __('messages.comment_placeholder') }}"></textarea>
