                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="save">
                                        ...
                                        @if($locale === config('app.fallback_locale'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                    wire:model.live="title" placeholder="Например: Городские туры">
                            ...
                            <div class="form-group">
                                <label>Slug</label>
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" readonly
                                    wire:model="slug" disabled placeholder="auto-generate если пусто">
                            ...
                            <div class="form-group">
                                ...
                                <!-- preview -->
                                <div class="mt-3 d-none mx-auto text-center" wire:loading wire:target="image"
