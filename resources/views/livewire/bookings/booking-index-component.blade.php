                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-centered table-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-pill badge-{{ $booking->status === 'paid' ? 'success' : ($booking->status === 'cancelled' ? 'danger' : 'warning') }} font-size-12">
                                            {{ ucfirst($booking->status) }}
                                        </span>
                                    </td>
                                    <td>
                                        @if($booking->referer)
                                            <span class="badge badge-soft-info font-size-12">{{ $booking->referer }}</span>
                                        @else
                                            <span class="text-muted">-</span>
                                        @endif
                                    </td>
