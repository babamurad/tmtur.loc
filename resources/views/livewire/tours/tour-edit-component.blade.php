                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 d-flex flex-wrap gap-2">
                                <button type="button"
                                        ...
                                        title="Автоматический перевод на английский через Gemini AI">
                                ...
                                <button type="button"
                                        wire:click="autoTranslateToKorean"
                                        wire:loading.attr="disabled"
                                        class="btn btn-sm btn-outline-success"
                                        title="Автоматический перевод на корейский через Gemini AI">
                                ...
                                <button type="button"
                                        wire:click="translateToAllLanguages"
                                        wire:loading.attr="disabled"
                                        class="btn btn-sm btn-outline-info"
                                        title="Автоматический перевод на все языки через Gemini AI">
