                            ...
                            @foreach($inclusions as $index => $inc)
                                <div class="card border mb-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom mb-2" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#inc-{{ $index }}-lang-{{ config('app.fallback_locale') }}" role="tab">
                                                    <span class="d-none d-sm-block">{{ strtoupper(config('app.fallback_locale')) }}</span>
                                                </a>
                                            </li>
                                            @foreach(config('app.available_locales') as $locale)
                                                @continue($locale === config('app.fallback_locale'))
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#inc-{{ $index }}-lang-{{ $locale }}" role="tab">
                                                        <span class="d-none d-sm-block">{{ strtoupper($locale) }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                        ...
                                        <div class="tab-content">
                                            {{-- Default Language Tab --}}
                                            <div class="tab-pane active" id="inc-{{ $index }}-lang-{{ config('app.fallback_locale') }}" role="tabpanel">
                                                <div class="form-group">
                                            ...
                                            @foreach(config('app.available_locales') as $locale)
                                                @continue($locale === config('app.fallback_locale'))
                                                <div class="tab-pane" id="inc-{{ $index }}-lang-{{ $locale }}" role="tabpanel">
                                                    <div class="form-group">
                                                        <label>Описание <span class="text-danger">*</span></label>
                                                        <input type="text" 
